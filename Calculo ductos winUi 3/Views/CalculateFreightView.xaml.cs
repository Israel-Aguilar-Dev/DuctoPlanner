...
namespace Calculo_ductos_winUi_3.Views
{
    ...
    /// </summary>
    public sealed partial class CalculateFreightView : Page
    {
        public StateViewModel stateApp { get; set; }
        public CalculateFreightView()
        {
        ...
        {
            CarouselScrollViewer.ChangeView(CarouselScrollViewer.HorizontalOffset - 260, null, null);
        }
        ...
        private async void CalculateFreight_Click(object sender, RoutedEventArgs e)
        {
            if (AppHasData())
            {
                await stateApp.CalculateFreigth(sender,e);
